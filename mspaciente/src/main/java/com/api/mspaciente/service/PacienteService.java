...
public class PacienteService {
    ...
    public void delete(String cpf) {
        Optional<Paciente> pacienteEncontrado = pacienteRepository.findByCpf(cpf);
        pacienteRepository.delete(pacienteEncontrado.get());
    }

    public Paciente update(String cpf, io.swagger.model.PacienteDTO paciente) {
        Optional<Paciente> pacienteEncontrado = pacienteRepository.findByCpf(cpf);
        pacienteEncontrado.get().setEndereco(paciente.getEndereco());
